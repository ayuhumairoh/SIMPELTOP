    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="alternatif.php">Data Laptop</a></li>
    ...
    <div class="row">
      ...
      <div class="col-lg-6 align-items-stretch">
        ...
        if (isset($_POST['tambah'])) {
          ...
          $query = mysqli_query($koneksi, "INSERT INTO alternatif(kode_alternatif, nama_alternatif, harga, processor, ram, vga, penyimpanan, resolusi, konektifitas) VALUES('$kode_alternatif', '$alternatif', '$harga', '$processor', '$ram', '$vga', '$penyimpanan', '$resolusi, $konektifitas')");
