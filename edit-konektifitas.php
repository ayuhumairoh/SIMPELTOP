  ...
  <main id="main">
    ...
    <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <h2>Edit Jumlah Konektifitas</h2>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Edit konektifitas</h2>
          <p>Silahkan lakukan edit sub kriteria Konektifitas</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
            <div class="card">
              <div class="card-body">
                <form method="post">
                  <?php
                  $query = mysqli_query($koneksi, "SELECT * FROM konektifitas WHERE id_konektifitas = '$id'");
                  $get = mysqli_fetch_array($query);
                  ?>
                  <div class="form-group mb-3">
                    <label for="sub">Nama Sub Kriteria</label>
                    <input type="text" name="sub" value="<?= $get['konektifitas']; ?>" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div class="form-group mb-3">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "UPDATE konektifitas SET konektifitas = '$sub', bobot = '$nilai' WHERE id_konektifitas = '$id'");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'edit-konektifitas.php'
                </script>
                ";
              }
            }
