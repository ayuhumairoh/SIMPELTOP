    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Edit Harga</h2>
          <p>Silahkan lakukan edit sub kriteria harga laptop</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
              ...
              <div class="card-body">
                <form method="post">
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" name="sub" value="<?= $get['harga']; ?>" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div class="form-group mb-3">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "UPDATE harga SET harga = '$sub', bobot = '$nilai' WHERE id_harga = '$id'");
