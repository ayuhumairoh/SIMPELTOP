...
<head>
  ...
  <title>SPK MOORA - Edit Kriteria</title>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Edit Kriteria</h2>
          <p>Silahkan lakukan edit Kriteria</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
              ...
              <div class="card-body">
                <form method="post">
                  ...
                  <div class="form-group mb-3">
                    <label for="sub">Nama Kriteria</label>
                    <input type="text" name="sub" value="<?= $get['nama_kriteria']; ?>" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div>
                  <label for="sub">Jenis Kriteria</label>
                  <select class="form-select form-select-md mb-3" name="jenis" aria-label="Jenis Kriteria">
                    <option selected><?= $get['jenis']; ?></option>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="number" name="nilai" value="<?= $get['bobot']; ?>" class="form-control" id="nilai" required autocomplete="off" step="0.01">
                  </div>
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "UPDATE kriteria SET nama_kriteria = '$sub', jenis = '$jenis', bobot = '$nilai' WHERE id_kriteria = '$id'");
