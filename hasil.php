    ...
    <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li><a class="nav-link scrollto active" href="hasil.php">Hasil Akhir</a></li>
...
<main id="main">
  ...
  <blockquote class="blockquote mb-0">
      <p><strong><h7>Peringkat teratas diambil berdasarkan perhitungan MOORA dengan nilai Yi (Maksimum - Minimum) tertinggi</h7></strong></p>
    </blockquote>
  </div>
</div>
