    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Edit Penyimpanan</h2>
          <p>Silahkan lakukan edit sub kriteria Penyimpanan</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
            <div class="card">
              <div class="card-body">
                <form method="post">
                  <?php
                  $query = mysqli_query($koneksi, "SELECT * FROM penyimpanan WHERE id_penyimpanan = '$id'");
                  $get = mysqli_fetch_array($query);
                  ?>
                  <div class="form-group mb-3">
                    <label for="sub">Nama Sub Kriteria</label>
                    <input type="text" name="sub" value="<?= $get['penyimpanan']; ?>" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div class="form-group mb-3">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "UPDATE penyimpanan SET penyimpanan = '$sub', bobot = '$nilai' WHERE id_penyimpanan = '$id'");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'edit-penyimpanan.php'
                </script>
                ";
              }
            }
