    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Tambah Penyimpanan</h2>
          <p>Silahkan lakukan penambahan sub kriteria Penyimpanan</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "INSERT INTO penyimpanan(penyimpanan, bobot) VALUES('$sub', '$nilai')");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'tambah-penyimpanan.php'
                </script>
                ";
              }
            }
