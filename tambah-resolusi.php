    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Tambah Resolusi Layar</h2>
          <p>Silahkan lakukan penambahan sub kriteria Resolusi Layar</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "INSERT INTO resolusi(resolusi, bobot) VALUES('$sub', '$nilai')");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'tambah-resolusi.php'
                </script>
                ";
              }
            }
