    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Tambah Jumlah Konektifitas</h2>
          <p>Silahkan lakukan penambahan sub kriteria Jumlah Konektifitas</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
              ...
              <div class="card-body">
                <form method="post">
                  <div class="form-group mb-3">
                    ...
                    <input type="text" name="sub" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div class="form-group mb-3">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "INSERT INTO konektifitas(konektifitas, bobot) VALUES('$sub', '$nilai')");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'tambah-konektifitas.php'
                </script>
                ";
              }
            }
