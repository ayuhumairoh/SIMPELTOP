    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Edit RAM</h2>
          <p>Silahkan lakukan edit sub kriteria RAM</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
            <div class="card">
              <div class="card-body">
                <form method="post">
                  <?php
                  $query = mysqli_query($koneksi, "SELECT * FROM ram WHERE id_ram = '$id'");
                  $get = mysqli_fetch_array($query);
                  ?>
                  <div class="form-group mb-3">
                    <label for="sub">Nama Sub Kriteria</label>
                    <input type="text" name="sub" value="<?= $get['ram']; ?>" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div class="form-group mb-3">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "UPDATE ram SET ram = '$sub', bobot = '$nilai' WHERE id_ram = '$id'");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'edit-ram.php'
                </script>
                ";
              }
            }
