    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Edit Processor</h2>
          <p>Silahkan lakukan edit sub kriteria Processor</p>
        </div>
        <div class="row">
          ...
          <div class="col-lg-6 align-items-stretch">
            <div class="card">
              <div class="card-body">
                <form method="post">
                  <?php
                  $query = mysqli_query($koneksi, "SELECT * FROM processor WHERE id_processor = '$id'");
                  $get = mysqli_fetch_array($query);
                  ?>
                  <div class="form-group mb-3">
                    <label for="sub">Nama Sub Kriteria</label>
                    <input type="text" name="sub" value="<?= $get['processor']; ?>" class="form-control" id="sub" required autocomplete="off">
                  </div>
                  <div class="form-group mb-3">
            ...
            if (isset($_POST['tambah'])) {
              ...
              $query = mysqli_query($koneksi, "UPDATE processor SET processor = '$sub', bobot = '$nilai' WHERE id_processor = '$id'");
              ...
              if ($query) {
                ...
                echo "
                <script>
                  document.location.href = 'edit-processor.php'
                </script>
                ";
              }
            }
